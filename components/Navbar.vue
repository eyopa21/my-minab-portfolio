...
<div>
  ...
  >
    <div class="flex justify-between items-center">
      ...
      >
        <NuxtLink to="/">Eyoba</NuxtLink>
      </div>
      <div class="hidden md:flex">
        <NuxtLink
          to="/"
          :class="[$route.fullPath == '/' ? 'border-primary' : 'border-white']"
        ...
        <NuxtLink
          to="/projects"
          :class="[
            $route.fullPath == '/projects' ? 'border-primary' : 'border-white',
          ]"
          class="hover:text-primary md:px-4 lg:px-12 border-b-2 pb-2"
          >Projects</NuxtLink
        >
      ...
      <div class="md:hidden">
        ...
        >
          ...
          <NuxtLink
            to="/skills"
            :class="[
              $route.fullPath == '/skills' ? 'text-primary' : 'text-secondary',
            ]"
            class="hover:text-primary"
            >Skills</NuxtLink
          >
          ...
          <NuxtLink
            to="/contact"
            :class="[
              $route.fullPath == '/contact' ? 'text-primary' : 'text-secondary',
            ]"
            class="hover:text-primary"
            >Contact</NuxtLink
          >
